...
class Tenis_Court():
    ...
    def __init__(self):
        ...
        self.VICTORY_SOUND = pygame.mixer.Sound("src/audio/cheer.wav")
        self.DEFEAT_SOUND = pygame.mixer.Sound("src/audio/sfxboo.wav")
...
class Movements(Tenis_Court):
    ...
    def ball_movement(self, ball, x_dir, y_dir, score):
        """ Docstring """
    ...
    def computer_movements(self, ball, x_dir, player):
        ...
        if x_dir == 1:
            if player.centery < ball.centery:
                ...
                player.y -= 1
        return player
    def computer_movements2(self, ball, x_dir, player):
        """ Docstring """
        if x_dir == -1:
            if player.centery < ball.centery:
                player.y += 1
...
class Sound(Tenis_Court):
    ...
    def sounds(self):
        ...
        self.SERVE_SOUND.set_volume(0.05)
